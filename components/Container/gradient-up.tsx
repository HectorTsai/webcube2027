...
export default function GradientUpContainer({
  ...
  // 完整類別（結構 + 顏色）
  const activeFullClasses = `${baseClasses} bg-gradient-to-b from-${color} to-${color}-50 text-${color}-content `;
  const activeHoverClasses = `${baseClasses} bg-gradient-to-b from-${color} to-${color}-30 text-${color}-content `;
  const inactiveFullClasses = `${baseClasses} bg-gradient-to-b from-base-70 to-base-30 text-base-content `;
  const inactiveHoverClasses = `${baseClasses} bg-gradient-to-b from-base-70 to-base-10 text-base-content `;
