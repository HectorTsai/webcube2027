...
export default function GradientCenterContainer({
  ...
  return <div class={`${classes} bg-gradient-to-r from-${colorFrom} via-${colorVia} to-${colorTo}`} style={{ width: widthStyle, height: heightStyle }} {...restProps}>{processedChildren}</div>;
}