...
export default function GradientMiddleContainer({
  ...
  return <div class={`${classes} bg-gradient-to-t from-${colorPrefix} via-${colorPrefix}-50 to-${colorPrefix}`} style={{ width: widthStyle, height: heightStyle }} {...restProps}>{children}</div>;
}
