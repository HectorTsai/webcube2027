...
export default function GradientLeftContainer({
  children,
  direction = "column",
  color = "primary",
  width = "auto",
  ...
  return <div class={`${classes} bg-gradient-to-r from-${colorPrefix} to-${colorPrefix}-50`} style={{ width: widthStyle, height: heightStyle }} {...restProps}>{children}</div>;
}
