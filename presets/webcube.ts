  ...
  return {
    ...
    shortcuts: [
      // WebCube 元件快捷類
      {
        ...
        '文字-主色內容': 'text-[var(--pc)]',
        '文字-次色內容': 'text-[var(--sc)]',
        '文字-強調色內容': 'text-[var(--ac)]',
        '文字-中性色內容': 'text-[var(--nc)]',
        '文字-資訊色': 'text-[var(--in)]',
        '文字-資訊色內容': 'text-[var(--inc)]',
        '文字-成功色': 'text-[var(--su)]',
        '文字-成功色內容': 'text-[var(--suc)]',
        '文字-警告色': 'text-[var(--wa)]',
        '文字-警告色內容': 'text-[var(--wac)]',
        '文字-錯誤色': 'text-[var(--er)]',
        '文字-錯誤色內容': 'text-[var(--erc)]',
        // 顏色快捷類 - 邊框色
        '邊框-主色': 'border-[var(--p)]',
        '邊框-次色': 'border-[var(--s)]',
        '邊框-強調色': 'border-[var(--a)]',
        '邊框-中性色': 'border-[var(--n)]',
        '邊框-背景3': 'border-[var(--b3)]',
        '邊框-資訊色': 'border-[var(--in)]',
        '邊框-成功色': 'border-[var(--su)]',
        '邊框-警告色': 'border-[var(--wa)]',
        '邊框-錯誤色': 'border-[var(--er)]'
      }
    ]
  }
}
