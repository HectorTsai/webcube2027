...
//
//   每個項目以 <Cube from="方塊:方塊:列表項目"> 包裹，取代舊版 Fragment 寫法。
//
      ...
      <div class="max-w-4xl mx-auto space-y-12">
        ...
        <header class="border-b border-slate-200 pb-6">
          ...
          <p class="text-sm text-slate-500 mt-1">
            {'<Cube from="方塊:方塊:列表">'} — 每個項目以 方塊:方塊:列表項目 包裹
          </p>
        </header>
        ...
        <section class="space-y-4">
          ...
          <Cube from="方塊:方塊:列表" context={c} color="base">
            <Cube from="方塊:方塊:列表項目"><div class="px-4 py-3">第一項</div></Cube>
            <Cube from="方塊:方塊:列表項目"><div class="px-4 py-3">第二項</div></Cube>
            <Cube from="方塊:方塊:列表項目"><div class="px-4 py-3">第三項</div></Cube>
          </Cube>
        </section>
            ...
            {colors.map(color => (
              <div class="space-y-1">
                ...
                <Cube from="方塊:方塊:列表" context={c} color={color}>
                  <Cube from="方塊:方塊:列表項目"><div class="px-4 py-2 text-sm">項目 A</div></Cube>
                  <Cube from="方塊:方塊:列表項目"><div class="px-4 py-2 text-sm">項目 B</div></Cube>
                  <Cube from="方塊:方塊:列表項目"><div class="px-4 py-2 text-sm">項目 C</div></Cube>
                </Cube>
              </div>
            ))}
          </div>
        ...
        <section class="space-y-4">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div class="space-y-1">
              ...
              <Cube from="方塊:方塊:列表" context={c} color="base">
                <Cube from="方塊:方塊:列表項目"><div class="px-4 py-3">使用者設定</div></Cube>
                <Cube from="方塊:方塊:列表項目"><div class="px-4 py-3">隱私權政策</div></Cube>
                <Cube from="方塊:方塊:列表項目"><div class="px-4 py-3">服務條款</div></Cube>
                <Cube from="方塊:方塊:列表項目"><div class="px-4 py-3">關於我們</div></Cube>
              </Cube>
            </div>
            <div class="space-y-1">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div class="space-y-1">
              ...
              <Cube from="方塊:方塊:列表" context={c} color="primary" divider>
                <Cube from="方塊:方塊:列表項目"><div class="px-4 py-3">第 1 列</div></Cube>
                <Cube from="方塊:方塊:列表項目"><div class="px-4 py-3">第 2 列</div></Cube>
                <Cube from="方塊:方塊:列表項目"><div class="px-4 py-3">第 3 列</div></Cube>
                <Cube from="方塊:方塊:列表項目"><div class="px-4 py-3">第 4 列</div></Cube>
                <Cube from="方塊:方塊:列表項目"><div class="px-4 py-3">第 5 列</div></Cube>
                <Cube from="方塊:方塊:列表項目"><div class="px-4 py-3">第 6 列</div></Cube>
              </Cube>
            </div>
            <div class="space-y-1">
        ...
        <section class="space-y-4">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Cube from="方塊:方塊:列表" context={c} color="info" divider stripe title="通知中心">
              <Cube from="方塊:方塊:列表項目"><div class="px-4 py-3 flex justify-between items-center">
                <span>系統更新</span>
            ...
            <Cube from="方塊:方塊:列表" context={c} color="success" divider stripe title="待辦清單">
              <Cube from="方塊:方塊:列表項目"><div class="px-4 py-3 flex items-center gap-2">
              ...
              <Cube from="方塊:方塊:列表項目"><div class="px-4 py-3 flex items-center gap-2 opacity-50 line-through">
          ...
          <div class="space-y-3">
            <div class="space-y-1">
              ...
              <Cube from="方塊:方塊:列表" context={c} color="base" direction="row" divider>
                <Cube from="方塊:方塊:列表項目"><div class="px-4 py-3 text-sm">首頁</div></Cube>
                <Cube from="方塊:方塊:列表項目"><div class="px-4 py-3 text-sm">產品</div></Cube>
                <Cube from="方塊:方塊:列表項目"><div class="px-4 py-3 text-sm">關於</div></Cube>
                <Cube from="方塊:方塊:列表項目"><div class="px-4 py-3 text-sm">聯絡</div></Cube>
              </Cube>
            </div>
            <div class="space-y-1">
              <div class="text-xs text-slate-400 font-medium">水平 + 無分隔線</div>
              <Cube from="方塊:方塊:列表" context={c} color="secondary" direction="row">
                <Cube from="方塊:方塊:列表項目"><div class="px-4 py-3 text-sm">標籤 A</div></Cube>
                <Cube from="方塊:方塊:列表項目"><div class="px-4 py-3 text-sm">標籤 B</div></Cube>
                <Cube from="方塊:方塊:列表項目"><div class="px-4 py-3 text-sm">標籤 C</div></Cube>
                <Cube from="方塊:方塊:列表項目"><div class="px-4 py-3 text-sm">標籤 D</div></Cube>
              </Cube>
            </div>
          </div>
        </section>
        ...
        <section class="space-y-4">
          ...
          <div class="grid grid-cols-1 gap-4">
            <Cube from="方塊:方塊:列表" context={c} color="primary" divider stripe title="團隊成員">
              <Cube from="方塊:方塊:列表項目"><div class="px-4 py-3 flex items-center gap-3">
            ...
            <Cube from="方塊:方塊:列表" context={c} color="accent" divider stripe title="最近活動">
              <Cube from="方塊:方塊:列表項目"><div class="px-4 py-3 flex items-start gap-3">
        ...
        <section class="space-y-4">
          <h2 class="text-lg font-black text-slate-800 flex items-center gap-2">
            ...
            分隔線方塊作為列表分隔（{'<Cube from="方塊:方塊:分隔線">'})
          </h2>
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div class="space-y-1">
              <div class="text-xs text-slate-400 font-medium">分隔線方塊</div>
              <Cube from="方塊:方塊:列表" context={c} color="primary">
                <Cube from="方塊:方塊:列表項目"><div class="px-4 py-3">個人檔案</div></Cube>
                <Cube from="方塊:方塊:列表項目"><div class="px-4 py-3">帳號安全</div></Cube>
                <Cube from="方塊:方塊:列表項目"><div class="px-4 py-3">通知設定</div></Cube>
                <Cube from="方塊:方塊:列表項目">
                  <Cube from="方塊:方塊:分隔線" label="功能" />
                </Cube>
                <Cube from="方塊:方塊:列表項目"><div class="px-4 py-3">關於我們</div></Cube>
                <Cube from="方塊:方塊:列表項目"><div class="px-4 py-3">聯絡客服</div></Cube>
                <Cube from="方塊:方塊:列表項目"><div class="px-4 py-3">版本資訊</div></Cube>
              </Cube>
            </div>
            <div class="space-y-1">
              <div class="text-xs text-slate-400 font-medium">divider + stripe + 分隔線方塊</div>
              <Cube from="方塊:方塊:列表" context={c} color="success" divider stripe>
                <Cube from="方塊:方塊:列表項目"><div class="px-4 py-3">水果</div></Cube>
                <Cube from="方塊:方塊:列表項目"><div class="px-4 py-3">蔬菜</div></Cube>
                <Cube from="方塊:方塊:列表項目">
                  <Cube from="方塊:方塊:分隔線" label="食品" />
                </Cube>
                <Cube from="方塊:方塊:列表項目"><div class="px-4 py-3">肉類</div></Cube>
                <Cube from="方塊:方塊:列表項目"><div class="px-4 py-3">海鮮</div></Cube>
                <Cube from="方塊:方塊:列表項目"><div class="px-4 py-3">乳製品</div></Cube>
              </Cube>
            </div>
          </div>
        </section>
        ...
        <section class="space-y-4">
          ...
          <div class="p-4 bg-slate-100 rounded-lg">
            <ul class="list-disc list-inside space-y-1 text-sm text-slate-600">
              ...
              <li><strong>divider</strong>: true / false — 項目之間顯示分隔線（需搭配 列表項目 的 styleConditions）</li>
              <li><strong>stripe</strong>: true / false — 偶數列顯示半透明背景（斑馬紋，需搭配 列表項目 的 styleConditions）</li>
              ...
              <li>每個項目以 <strong>&lt;Cube from="方塊:方塊:列表項目"&gt;</strong> 包裹</li>
              <li>分隔線方塊也需以 列表項目 包裹</li>
            </ul>
          </div>
        </section>
