...
const DEFAULTS = {
  ...
  配色: "",
  骨架: "",
  風格: "風格:風格:經典實心",   // 🌟 負責全站物理材質、特效（如 glow, crystal）的風格 ID
  動畫: "動畫:動畫:基本",
  裝飾: "裝飾:裝飾:無裝飾",
  圖示: "圖示集:圖示集:經典外框", // 🌟 [第六金剛] 圖示集 ID（存圖示引用，非 SVG 實體）
};
...
export default class 佈景主題 extends 資料 {
  ...
  public constructor(
    ...
    this.圖示 = (data?.圖示 as string) ?? DEFAULTS.圖示;
