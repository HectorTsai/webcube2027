      ...
      <section>
        ...
        <div class="flex flex-wrap gap-6">
          {testIds.map(id => (
            <div class="flex flex-col items-center gap-2 p-4 bg-base-100 shadow-md rounded-lg">
              <div class="flex justify-center items-center p-4 bg-base-200 rounded-lg">
                <Cube from="方塊:方塊:圖片" src={`/media/v1/image/${id}`} alt={id.replace("影像:影像:", "")} width="100" height="100" />
              </div>
        ...
        <div class="flex flex-wrap gap-6 items-end">
          {sizeVariants.map(({ width, height, label }) => (
            <div class="flex flex-col items-center gap-2 p-4 bg-base-100 shadow-md rounded-lg">
              ...
              <div class="flex justify-center items-center p-4 bg-base-200 rounded-lg">
                <Cube from="方塊:方塊:圖片" id="影像:影像:hono" alt={`尺寸 ${width}x${height}`} width={width} height={height} />
              </div>
            </div>
          ))}
        </div>
      ...
      <section>
        ...
        <div class="flex flex-wrap gap-6">
          {testIds.map(id => (
            <div class="flex flex-col items-center gap-2 p-4 bg-base-100 shadow-md rounded-lg">
              <div class="flex justify-center items-center p-4 bg-base-200 rounded-lg">
                <Cube from="方塊:方塊:圖片" id={id} alt="寬度 100" width="100" />
              </div>
      ...
      <section>
        ...
        <div class="flex flex-wrap gap-6">
          {testIds.map(id => (
            <div class="flex flex-col items-center gap-2 p-4 bg-base-100 shadow-md rounded-lg">
              <div class="flex justify-center items-center p-4 bg-base-200 rounded-lg">
                <Cube from="方塊:方塊:圖片" id={id} alt="高度 100" height="100" />
              </div>
              <span class="text-sm text-base-content/70">{id}</span>
            </div>
          ))}
        ...
        <div class="flex flex-wrap gap-6">
          {["lazy", "eager"].map(loading => (
            <div class="flex flex-col items-center gap-2 p-4 bg-base-100 shadow-md rounded-lg">
              ...
              <div class="flex justify-center items-center p-4 bg-base-200 rounded-lg">
                <Cube from="方塊:方塊:圖片" id="影像:影像:hono" alt={`${loading} 1`} width="100" height="100" loading={loading} />
              </div>
            </div>
          ))}
        </div>
        ...
        <div class="flex flex-wrap gap-6">
          {objectFitOptions.map(fit => (
            <div class="flex flex-col items-center gap-2 p-4 bg-base-100 shadow-md rounded-lg">
              ...
              <div class="flex justify-center items-center p-4 bg-base-200 rounded-lg">
                <Cube from="方塊:方塊:圖片" id="影像:影像:hono" alt={`Object-fit: ${fit}`} width="100" height="100" objectFit={fit} />
              </div>
            </div>
          ))}
        </div>
