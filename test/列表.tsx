...
//   </Cube>
//
// 注意：每個項目外層需包 Hono Fragment <></> 才能讓 Children.map 正确拆開（防止 Hono 融合連續原生標籤）。
      ...
      <div class="max-w-4xl mx-auto space-y-12">
        ...
        <section class="space-y-4">
          ...
          <Cube from="方塊:方塊:列表" context={c} color="base">
            <><div class="px-4 py-3">第一項</div></>
            <><div class="px-4 py-3">第二項</div></>
            <><div class="px-4 py-3">第三項</div></>
          </Cube>
        </section>
            ...
            {colors.map(color => (
              <div class="space-y-1">
                ...
                <Cube from="方塊:方塊:列表" context={c} color={color}>
                  <><div class="px-4 py-2 text-sm">項目 A</div></>
                  <><div class="px-4 py-2 text-sm">項目 B</div></>
                  <><div class="px-4 py-2 text-sm">項目 C</div></>
                </Cube>
              </div>
            ))}
          </div>
        ...
        <section class="space-y-4">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div class="space-y-1">
              ...
              <Cube from="方塊:方塊:列表" context={c} color="base">
                <><div class="px-4 py-3">使用者設定</div></>
                <><div class="px-4 py-3">隱私權政策</div></>
                <><div class="px-4 py-3">服務條款</div></>
                <><div class="px-4 py-3">關於我們</div></>
              </Cube>
            </div>
            <div class="space-y-1">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div class="space-y-1">
              ...
              <Cube from="方塊:方塊:列表" context={c} color="primary" divider>
                <><div class="px-4 py-3">第 1 列</div></>
                <><div class="px-4 py-3">第 2 列</div></>
                <><div class="px-4 py-3">第 3 列</div></>
                <><div class="px-4 py-3">第 4 列</div></>
                <><div class="px-4 py-3">第 5 列</div></>
                <><div class="px-4 py-3">第 6 列</div></>
              </Cube>
            </div>
            <div class="space-y-1">
        ...
        <section class="space-y-4">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <Cube from="方塊:方塊:列表" context={c} color="success" divider stripe title="待辦清單">
              ...
              <><div class="px-4 py-3 flex items-center gap-2 opacity-50 line-through">
          ...
          <div class="space-y-3">
            <div class="space-y-1">
              ...
              <Cube from="方塊:方塊:列表" context={c} color="base" direction="row" divider>
                <><div class="px-4 py-3 text-sm">首頁</div></>
                <><div class="px-4 py-3 text-sm">產品</div></>
                <><div class="px-4 py-3 text-sm">關於</div></>
                <><div class="px-4 py-3 text-sm">聯絡</div></>
              </Cube>
            </div>
            <div class="space-y-1">
              <div class="text-xs text-slate-400 font-medium">水平 + 無分隔線</div>
              <Cube from="方塊:方塊:列表" context={c} color="secondary" direction="row">
                <><div class="px-4 py-3 text-sm">標籤 A</div></>
                <><div class="px-4 py-3 text-sm">標籤 B</div></>
                <><div class="px-4 py-3 text-sm">標籤 C</div></>
                <><div class="px-4 py-3 text-sm">標籤 D</div></>
              </Cube>
            </div>
          </div>
        </section>
        ...
        <section class="space-y-4">
          <h2 class="text-lg font-black text-slate-800 flex items-center gap-2">
            ...
            separator 分隔線（{'<div role="separator">'})
          </h2>
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div class="space-y-1">
              <div class="text-xs text-slate-400 font-medium">divider + separator（分隔線在 separator 處斷開）</div>
              <Cube from="方塊:方塊:列表" context={c} color="primary" divider>
                <><div class="px-4 py-3">個人檔案</div></>
                <><div class="px-4 py-3">帳號安全</div></>
                <><div class="px-4 py-3">通知設定</div></>
                <><div role="separator"><hr class="border-current/15" /></div></>
                <><div class="px-4 py-3">關於我們</div></>
                <><div class="px-4 py-3">聯絡客服</div></>
                <><div class="px-4 py-3">版本資訊</div></>
              </Cube>
            </div>
            <div class="space-y-1">
              ...
              <Cube from="方塊:方塊:列表" context={c} color="success" divider stripe>
                <><div class="px-4 py-3">水果</div></>
                <><div class="px-4 py-3">蔬菜</div></>
                <><div role="separator"><hr class="border-current/15" /></div></>
                <><div class="px-4 py-3">肉類</div></>
                <><div class="px-4 py-3">海鮮</div></>
                <><div class="px-4 py-3">乳製品</div></>
              </Cube>
            </div>
          </div>
        </section>
        ...
        <section class="space-y-4">
          ...
          <div class="p-4 bg-slate-100 rounded-lg">
            <ul class="list-disc list-inside space-y-1 text-sm text-slate-600">
              ...
              <li>每個項目外層需包 <strong>&lt;&gt;...&lt;/&gt;</strong>（Hono Fragment），wrapChild 才會正確拆開每個項目並各自包裝 &lt;li&gt;</li>
              <li>在列表中插入 <strong>&lt;&gt;&lt;div role="separator"&gt;&lt;hr /&gt;&lt;/div&gt;&lt;/&gt;</strong> 作為群組分隔線，role 會自動傳遞到外層 &lt;li&gt;</li>
